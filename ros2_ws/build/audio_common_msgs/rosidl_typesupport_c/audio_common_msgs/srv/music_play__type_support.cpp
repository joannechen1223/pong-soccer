...
static const _MusicPlay_Request_type_support_symbol_names_t _MusicPlay_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, audio_common_msgs, srv, MusicPlay_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, audio_common_msgs, srv, MusicPlay_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, audio_common_msgs, srv, MusicPlay_Request)() {
  return &::audio_common_msgs::srv::rosidl_typesupport_c::MusicPlay_Request_message_type_support_handle;
}
...
static const _MusicPlay_Response_type_support_symbol_names_t _MusicPlay_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, audio_common_msgs, srv, MusicPlay_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, audio_common_msgs, srv, MusicPlay_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, audio_common_msgs, srv, MusicPlay_Response)() {
  return &::audio_common_msgs::srv::rosidl_typesupport_c::MusicPlay_Response_message_type_support_handle;
}
...
static const _MusicPlay_type_support_symbol_names_t _MusicPlay_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, audio_common_msgs, srv, MusicPlay)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, audio_common_msgs, srv, MusicPlay)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, audio_common_msgs, srv, MusicPlay)() {
  return &::audio_common_msgs::srv::rosidl_typesupport_c::MusicPlay_service_type_support_handle;
}
