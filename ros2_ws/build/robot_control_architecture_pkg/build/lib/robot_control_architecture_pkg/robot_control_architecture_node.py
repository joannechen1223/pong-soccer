...
class RobotControlArchitecture(Node):
    ...
    def control_cycle(self):
        ...
        Copy from Lab 2
        '''
        # print('Start control_cycle')
        # print(self.last_scan)
        # print('in control_cycle')
        # print(self.last_scan)
        if self.last_scan is None:
            # print('Last Scan is None')
            return
    ...
    def detect_red_object(self):
        ...
        # Count red pixels
        # print(center_region[50,50,2], center_region[50,50,0], center_region[50,50,1])
    ...
    def check_forward_2_speech(self):
        if self.person_size > self.HUMAN_DISTANCE:
            ...
            # if len(filtered_inf) == 0:
            #     return False
            # elif sum(filtered_inf)/len(filtered_inf) < self.OBSTACLE_DISTANCE:
            #     if self.person_size > self.HUMAN_DISTANCE:
            #         return True
            # else:
            return False
