...
class RobotControlArchitecture(Node):
    ...
    def rgb_callback(self, msg):
        # print(f"in rgb_callback: {msg.encoding}")
        # encoding bgr8
    ...
    def person_detection_callback(self, msg):
        # print("in person_detection_callback")
        for detection in msg.detections:
            ...
            for result in detection.results:
                ...
                if (class_id == '15') and (score > 0.98):
                    # print(f"person detected; score: {score}")
    ...
    def control_cycle(self):
        ...
        if self.state == self.SPIN:
            ...
            if self.check_forward_2_move_left(): 
                print('Forward ==> Move Left')                      
                self.go_state(self.MOVE_LEFT)
            elif self.check_forward_2_speech():
    ...
    def check_forward_2_move_left(self):
        ...
        red_object_detected = self.detect_red_object()

        # Return True if either a LIDAR obstacle is detected and a red object is detected
        return lidar_obstacle and red_object_detected
    ...
    def check_forward_2_stop(self):
        ...
        # print(f"center_depth: {self.center_depth}")
    ...
    def check_forward_2_speech(self):
        ...
        # Return True if either a LIDAR obstacle is detected and a red object is not detected
        return lidar_obstacle and not red_object_detected
        # return False
...
def main(args=None):
    print('Hi from robot_control_architecture_pkg.')
